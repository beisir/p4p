...
$.when(keywordEntity.getKeywordList()).done(function(keywords) {
    ...
    var p4pBusinessLogicEntity = new p4pBusinessLogic({
        ...
        template: [
            ...
            '    <div class="proImgCon">',
            '        <a href="{{product.searchResultfoUrl}}" rel="nofollow" title="{{product.searchResultfoTitle}}" target="_blank"><img src="{{product.searchResultfoImageBig}}"></a>',
            '        <em>{{product.keyword}}</em>',
            '    </div>',
            '    <dl>',
            '        <dt><a href="{{product.searchResultfoUrl}}" rel="nofollow" target="_blank">{{product.searchResultfoTitle}}</a></dt>',
            '        <dd>',
            '            <span>{{product.pretreatPrice}}</span>',
            '        </dd>',
            '    </dl>',
            '    <div class="proBoxAlert">',
            '       <a href="//s.hc360.com/?w={{product.keyword}}&mc=seller" title="发现更多的相似资源" rel="nofollow" target="_blank">',
            '           <h3>相似资源</h3>',
            '           <p>发现更多的相似资源</p>',
            '       </a>',
            '    </div>',
