...
var templateEntity = [
        ...
        '</a>',
        '<div class="A-title"><a href="//b2b.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}" target="_blank">{{product.searchResultfoTitle}} </a></div>',
