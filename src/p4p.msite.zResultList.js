     ...
     _template=[
             ...
             '<li class="swiper-slide">',
                 '<div class="ListImgBox">',
                     ...
                     '<a href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}"><img src="{{product.searchResultfoImageBig}}"></a>',
                 '</div>',
                 '<div class="ImgBot">',
                     '<p class="til"><a href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}">{{product.searchResultfoTitle}}</a></p>',
                     '<p class="comp"><a href="http://m.hc360.com/b2b/{{product.searchResultfoUserName}}/">{{product.searchResultfoCompany}}</a></p>',
                     '<div class="icoBox">',
                         '<em class="ico1"></em>',
                         '<em class="ico4"></em>',
                     '</div>',
                     '<div class="priBox">￥{{product.searchResultfoUnitPrice}}</div>',
                     '<div class="qtBox"><a href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html" rel="nofollow" onclick="sendUserlogsElement(\'UserBehavior_p4p_zmobile\');" target="_blank" >询价</a></div>',
                     '<p class="adTxt">广告</p>',
                 '</div>',
             '</li>',
             '{{/each}}',
