	...
	var htmlTemplate = {
			...
			"p4p": function() {
				var htmlTemplateArray = [
					...
					'		<a href="//js.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}" onclick="sendUserlogsElement(&quot;UserBehavior_p4p_js_search_2_tupian&quot;);">',
					'			<img alt="{{product.searchResultfoTitle}}" height="100" width="84" src="{{product.searchResultfoImageSmall}}">',
					'		</a>',
					'	</div>',
					'	<div class="proRigName">',
					'		<p>',
					'			<a href="//js.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}" onclick="sendUserlogsElement(&quot;UserBehavior_p4p_js_search_2_tupian&quot;);">{{product.searchResultfoTitle}}</a>',
					'		</p>',
					'		<div class="proRigBot">',
					'			<dl>',
			...
			"aladdin": function() {
				var htmlTemplateArray = [
					...
					'	<div class="ListImgBox">',
					'		<em class="hot">HOT</em>',
					'		<a href="//js.hc360.com/supplyself/{{product.bcid}}.html" target="_blank" title="{{product.bctitle}}">',
					'			<img alt="{{product.bctitle}}" height="100" width="84" src="{{product.bcimage}}">',
					'		</a>',
					'	</div>',
					'	<div class="proRigName">',
					'		<p>',
					'		 	<a href="//js.hc360.com/supplyself/{{product.bcid}}.html" target="_blank" title="{{product.bctitle}}">{{product.bctitle}}</a>',
					'		</p>',
					'		<div class="proRigBot">',
					'			<dl>',
		...
		deferredAladdin = $.ajax({
			url: '//champion.hc360.com/champion/mStation/getAladInfo.html',
			type: 'GET',
			dataType: 'jsonp',
			timeout: 3000,
			data: {
