...
var templateEntity = [
    ...
    '<li>',
        '<div class="p4pImg">',
            '<a href="http://b2b.hc360.com/supplyself/{{product.searchResultfoId}}.html"   target="_blank"  title="{{product.searchResultfoTitle}}">',
        ...
        '<div class="wReproinfo">',
            '<a  href="http://b2b.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}" target="_blank" >{{product.searchResultfoTitle}}</a>',
        '</div>',
    '</li>',
    '{{/each}}',
    '</ul>'
