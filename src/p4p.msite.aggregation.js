...
var _ua = require('./ua').parseUA(window.navigator.userAgent),
    ...
    _template = {
        firstTempHTMLArray: [
            ...
            '<div class="bigPic"><a  href="//m.hc360.com/supplyself/{{product.searchResultfoId}}.html"><img src="{{product.searchResultfoImageBig}}"></a></div>',
            '<div class="bigRtxt">',
            '<p class="til">',
            '<a  href="//m.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{ product.searchResultfoText }}"><span>{{#product.searchTitle}}</span></a>',
            '</p>',
        ...
        listP4pTempArr: [
            ...
            '<li>',
            '<div class="listImg">',
            '<a  href="//m.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}" ><img src="{{product.searchResultfoImageBig}}" alt="{{product.searchResultfoTitle}}"></a>',
            '</div>',
            '<div class="listTxt">',
            '<p class="til"><a  href="//m.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}" ><span>{{#product.searchTitle}}</span></a></p>',
            '<p class="comp"><a  href="//m.hc360.com/b2b/{{product.searchResultfoUserName}}/" title="{{product.searchResultfoCompany}}" >{{product.searchResultfoCompany}}</a><em>广告</em></p>',
            '<div class="icoBox">',
            '<span class="ico1"></span>',
            '<span class="ico4"></span>',
            '<span class="p4pIco"></span>',
