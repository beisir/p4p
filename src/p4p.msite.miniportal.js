				...
				hot: {
					...
					html: function() {
						var _tempHTMLArray = [
							...
							'            	<em class="yzIco"></em>',
							'                <a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_1_tupian&quot;)" data-query="sendClickInfo" href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}">',
							...
							'                </p>',
							'                <p class="til">',
							'                    <a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_1_tupian&quot;)" title="{{product.searchResultfoTitle}}" data-query="sendClickInfo" href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html">{{#product.pretreatTitle}}</a>',
							'                </p>',
							'                <p class="comp"><a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_1_tupian&quot;)" href="http://m.hc360.com/b2b/{{product.searchResultfoUserName}}/">{{product.searchResultfoCompany}}</a></p>',
							'                <div class="icoBox">',
							'                    <em class="ico1"></em>',
							'                    <em class="ico4"></em>',
							'                </div>',
							...
							// '    </div>',
							// '    <div class="ImgBot">',
							// '        <p><a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_1_tupian&quot;)"  data-query="sendClickInfo" href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html">{{product.searchResultfoTitle}}</a></p>',
							// '        <div class="priBox">',
							// '            <dl>',
				...
				info: {
					...
					html: function() {
						var _tempHTMLArray = [
							...
							'            <em class="mAd">广告</em>',
							'            <div class="ListImgBox">',
							'                <a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_tupian_1_tupian&quot;)" data-query="sendClickInfo" href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}"><img src="{{product.searchResultfoImageBig}}"></a>',
							'            </div>',
							'            <div class="ImgBot2">',
							'                <p class="Tab2Name">',
							'                    <a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_1_tupian&quot;)" title="{{product.searchResultfoTitle}}" data-query="sendClickInfo" href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html">{{#product.pretreatTitle}}</a>',
							...
							// '    <em class="mAd">广告</em>',
							// '    <div class="ListImgBox">',
							// '        <a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_price_1_tupian&quot;)" data-query="sendClickInfo" href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html" title="{{product.searchResultfoTitle}}"><img src="{{product.searchResultfoImageSmall}}"></a>',
							// '    </div>',
							// '    <div class="ImgBot2">',
							// '        <p class="Tab2Name"><a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_price_1_tupian&quot;)"  data-query="sendClickInfo" href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html">{{product.searchResultfoTitle}}</a></p>',
							// '        <p class="Tab2Price">参考价<span>&yen;{{product.searchResultfoUnitPrice}}</span><em class="flat"></em></p>',
							// '        <p class="BotBtn2">',
							// '            <button type="button" onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_price_1_tupian&quot;);alertInquiryInfo(&quot;{{product.searchResultfoProviderid}}&quot;,&quot;{{product.searchResultfoId}}&quot;,&quot;{{product.searchResultfoText}}&quot;,&quot;{{product.searchResultfoUserName}}&quot;,&quot;jiage&quot;)">实时报价</button>',
							// '        </p>',
				...
				img: {
					...
					html: function() {
						var _tempHTMLArray = [
							...
							'    </div>',
							'    <div class="ImgBot">',
							'        <p><a onclick="sendUserlogsElement(&quot;UserBehavior_p4p_m_cp_tupian_1_tupian&quot;)" data-query="sendClickInfo" href="http://m.hc360.com/supplyself/{{product.searchResultfoId}}.html">{{product.searchResultfoTitle}}</a></p>',
							'    </div>',
							'</li>',
							'{{/each}}'
						];
	...
	p4pBusinessLogicEntity.addEventListener('onEndRender', function(targetElement) {
		...
		if (_this.hot || _this.info) {
			...
			if (_this.cache.prolist.length > 1) {
				 ...
				 * [加载swiper组件]
				 */
				$.getScript('http://style.org.hc360.com/js/M-hc/mIndex/swiper.min.js', function() {
